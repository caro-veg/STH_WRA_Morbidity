...
file1 <- "fertilisedFemaleWorms_old_20-50_treat1x_100reps.RData"
file2 <- "fertilisedFemaleWorms_new_20-50_treat1x_100reps.RData"
...
path <- "D:\\STH\\ModellingConsortium\\WRAquestion\\EMC_data\\treatedFoI\\"
...
path <- "D:\\STH\\ModellingConsortium\\WRAquestion\\L_FoI_Treated\\"
file1 <- "fertilisedFemaleWorms_old_20-50_treat2x_100reps.RData"
file2 <- "fertilisedFemaleWorms_new_20-50_treat2x_100reps.RData"
stub1 <- substring(file1, first=22, last=41)
stub2 <- substring(file2, first=22, last=41)
results_old <- get(load(paste0(path, file1)))
results_new <- get(load(paste0(path, file2)))
...
path <- "D:\\STH\\ModellingConsortium\\WRAquestion\\L_FoI_Treated\\"
file1 <- "fertilisedFemaleWorms_old_50-70_treat2x_100reps.RData"
file2 <- "fertilisedFemaleWorms_new_50-70_treat2x_100reps.RData"
stub1 <- substring(file1, first=22, last=41)
stub2 <- substring(file2, first=22, last=41)
results_old <- get(load(paste0(path, file1)))
results_new <- get(load(paste0(path, file2)))
...
p <- p + scale_y_continuous(breaks=seq(0, 130, 20)) + coord_cartesian(ylim=c(0,130)) 
...
print(p)
#ggsave(paste0(outpath, "summaryFigureTreatedFoI.jpeg"), p, dpi=300)
